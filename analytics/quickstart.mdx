---
title: Analytics quickstart — your first dashboard
sidebarTitle: Quickstart
description: Get started with Analytics by connecting a data source, exploring sample queries, and building your first dashboard with charts in under 15 minutes.
---
...
- Learn how to [create a dashboard](/analytics/dashboards/create-dashboard) and organize charts into a single view.
