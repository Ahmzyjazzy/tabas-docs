---
title: Integrations quickstart — connect your first app
sidebarTitle: Quickstart
description: Connect your first integration in under 10 minutes. Authenticate a source app, map fields, run a test sync, and start automating workflows.
---
