---
title: CRM connectors for Salesforce and HubSpot
description: Sync contacts, accounts, deals, and activity from Salesforce, HubSpot, and other CRMs. Configure field mapping, sync direction, and conflict rules.
---
