---
title: Configure webhook endpoints and events
description: Register a webhook endpoint URL, subscribe to event types, verify signatures, and handle retries to receive real-time updates from Tabas.
---
...
<Steps>
  ...
  <Step title="Select events">
    ...
    The events picker shows the full list of available event types and their payload schemas.
  </Step>
