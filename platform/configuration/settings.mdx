---
title: General workspace settings and preferences
description: Configure your workspace name, timezone, locale, branding, and display preferences. Adjust defaults that apply across all projects and members.
---
